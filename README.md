...
VLM-o is a 3B parameter multi-modal vision model built for image analysis and object detection. This model is inspired by the [PaliGemma](https://arxiv.org/pdf/2407.07726) architecutre. To read my kinda technical report, check out my [blog post](https://vpareek2.github.io/blogs/posts_html/blog2.html).

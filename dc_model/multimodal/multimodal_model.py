...
class PaliGemmaForConditionalGeneration(nn.Module):
    ...
    def _merge_input_ids_with_image_features(
        ...
        batch_size, _, embed_dim = image_features.shape
    ...
    def forward(
        ...
        # SigLip now returns both final output and intermediate states
        selected_image_feature, all_hidden_states = self.vision_tower(pixel_values.to(inputs_embeds.dtype))
        
        # Pass both final output and intermediate states to the projector
        image_features = self.multi_modal_projector(selected_image_feature, all_hidden_states)
